...
const SearchPageSection = () => {
  ...
  useEffect(() => {
    (async () => {
      fetchItems(setSongs, process.env.REACT_APP_SONGS_ENDPOINT!);
      fetchItems(setUsers, process.env.REACT_APP_USERS_ENDPOINT!);
      fetchItems(setPlaylists, process.env.REACT_APP_PLAYLISTS_ENDPOINT!);
    ...
    <section className="section search-page-section">
      <div className="container search-page-top-container">
        ...
        <div className="container entities-container">
          <SearchEntity entityName="Songs" entityCount={songs.length}/>
          <SearchEntity entityName="Users" entityCount={users.length}/>
          <SearchEntity entityName="Playlists" entityCount={playlists.length}/>
        </div>
        <div className="container"></div>
      </div>
      {resultsComponent}
